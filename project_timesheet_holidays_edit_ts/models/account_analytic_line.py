...
class AccountAnalyticLine(models.Model):
    ...
    def _check_can_write(self, values):
        # A holiday generated timesheet can only be modified if holiday type allows it for everybody,
        #  or if the user is an approver
        obj = self
        ...
        if holiday and (
            ...
            not set(values.keys()) - set(self._get_ts_from_holiday_edit_fields())
        ):
            obj = self.sudo()
